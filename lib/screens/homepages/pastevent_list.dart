...
class PastDetailsScreen extends StatefulWidget {
  ...
  @override
  State<PastDetailsScreen> createState() => _pastDetailsScreenState();
}

class _pastDetailsScreenState extends State<PastDetailsScreen> {
  bool isLoading = true;
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text(
                '    ${widget.event['aboutEvent'] ?? 'Not specified'}',
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
              '"Are you sure you want to cancel this event? Once cancelled, all associated information will be deleted, and attendees will be notify.this action cannot be undone"'),
          actions: <Widget>[
            TextButton(
              onPressed: () {
